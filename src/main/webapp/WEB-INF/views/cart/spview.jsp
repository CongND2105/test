...
<body>
<h1>&#32;&#32;&#32;&#32;&#32;&#32;Hello Java 5 Students Welcome to Shopping Cart</h1>
<!--  How are you today? -->
									     <p><font color="blue">Hello HTML5</font></p>
	<div class="wrapper">
		<div class="container">
			<div class="row g-1">
				...
				<a href="/cart/view" style="text-decoration: none; margin-top: 51px;text-align: center; color: orangered;"> 
					<div class="gio">
